...
//
//   g++ -std=c++20 -O2 -I lib/include -I build/dev/lib/generated -I build/dev/_deps/nlohmann_json-src/single_include tools/analysis/ore-vein-analyze.cpp -L build/dev/lib -lstratum_core -lz -o build/ore-vein-analyze
